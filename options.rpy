...
init -1 python hide:
    ...
    config.window_title = u"strat-rpg test"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "strat-rpg test"
    config.version = "0.0"
    ...
    config.say_attribute_transition = Dissolve(10.0)
...
python early:
    config.save_directory = "strat-rpg test-1429131356"
